...
상태 코드도 응답의 시작부분에 추가되어 요청의 성공과 실패를 파악할 수 있게됨
Content-Type도입으로 MTML 이외의 문서 전송 가능함
...
-> Frame이 각 요청의 Stream을 통해 전달되며 그로 인해 동시에 여러 요청을 처리할 수 있게 됨
예시
